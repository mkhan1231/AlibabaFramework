    ...
    public WebDriver getLocalDriver(String browserName, String os) {
        if (browserName.equalsIgnoreCase("chrome")) {
            if (os.equalsIgnoreCase("windows")) {
                ...
                System.setProperty("webdriver.chrome.driver", "C:\\Users\\Mahmud Khan\\IdeaProjects\\AlibabaOne\\Generic\\Driver\\chromedriver");
                driver = new ChromeDriver();
            }
        } else if (browserName.equalsIgnoreCase("firefox")) {
            if (os.equalsIgnoreCase("windows")) {
                System.setProperty("webdriver.gecko.driver", "C:\\Users\\Mahmud Khan\\IdeaProjects\\AlibabaOne\\Generic\\Driver\\geckodriver.exe");
                driver = new ChromeDriver();
            } else if (os.equalsIgnoreCase("mac")) {
                System.setProperty("webdriver.gecko.driver", "C:\\Users\\Mahmud Khan\\IdeaProjects\\AlibabaOne\\Generic\\Driver\\geckodriver");
                driver = new ChromeDriver();
            }
        }
        return driver;
